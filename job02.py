...
print(classe)
# À l'aide de l'objet créé au Job 1
# On utilise le "point" (.) pour accéder à ce qu'il y a dedans.
print(f"Le nombre1 est {classe.nombre1}")
print(f"Le nombre2 est {classe.nombre2}")